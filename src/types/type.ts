...
export type LandingCategoryCardProps = {
  image: string | null;
  name: string;
  description: string;
};

export type ScrollStepProps = {
  title: string;
  description: string;
  imageSrc: string;
  reverse?: boolean;
...
export type SkeletonCategoryCardProps = {
  repeat?: number;
};
...
export type mergeSubmissionWithIdSubmissionRaw = {
  title: string;
  description: string;
  profileImage: string;
  imageUrl: string;
...
export type mergeSubmissionWithIdMemberQuest = {
  id: number;
  title: string;
  description: string;
  imageUrl: string;
